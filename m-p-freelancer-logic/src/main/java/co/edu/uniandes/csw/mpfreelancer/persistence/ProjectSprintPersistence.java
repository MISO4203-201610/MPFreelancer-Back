 ...
 */
@Stateless
public class ProjectSprintPersistence extends CrudPersistence<ProjectSprintEntity>{
    ...
    @Override
    protected Class<ProjectSprintEntity> getEntityClass() {
        return ProjectSprintEntity.class;
    }
    ...
    public int count(Long projectId) {
        Query count = this.em.createQuery("select count(u) from ProjectSprintEntity u where u.project.id=" + projectId);
     ...
     */
    public List<ProjectSprintEntity> findAll(Long projectId) 
    {
        Query q = this.em.createQuery("select u from ProjectSprintEntity u where u.project.id=" + projectId);
     ...
     * @return Colecction of instances of handled entity
     */
    public List<ProjectSprintEntity> findAll(Long projectId, Integer page, Integer maxRecords) {
        Query q = getEntityManager().createQuery("select u from ProjectSprintEntity u where u.project.id=" + projectId);
